  ...
  <header>
    <div className="w-screen shadow-md py-3 px-1.5 fixed top-0 bg-gray z-30">
        <nav className='flex justify-between mx-auto w-4/5 items-center'>
            ...
            <Link href='/login'><div className='ltsm:hidden rounded-3xl py-3 px-8 text-white bg-primary-blue font-medium cursor-pointer hover:shadow-md'>Đăng nhập</div></Link>
        </nav>
        </div>
